...
const metrics = [
  ...
  { label: "Contracts", value: "DocuSeal", detail: "Chosen free signing path", icon: FileText },
...
const contractSteps = [
  "Pick or create DocuSeal contract template",
  "Fill client, project, price, and scope",
  "Send signing link from the admin workspace",
  "Track sent, viewed, signed, and stored status",
];
...
const nextBuild = [
  ...
  "Connect DocuSeal first for contracts and signed PDF tracking.",
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <Button variant="hero-outline" asChild>
                  <a href="#contracts">Plan contract</a>
                </Button>
              </div>
            </div>
          </div>
